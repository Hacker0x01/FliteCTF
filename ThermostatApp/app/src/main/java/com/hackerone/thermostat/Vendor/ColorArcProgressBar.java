package com.hackerone.thermostat.Vendor;
...
import com.hackerone.thermostat.R;
...
public class ColorArcProgressBar extends View {
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        bgArcColor = a.getString(R.styleable.ColorArcProgressBar_arc_color);
        longDegreeColor = a.getString(R.styleable.ColorArcProgressBar_degree_color);
        shortDegreeColor = a.getString(R.styleable.ColorArcProgressBar_degree_color);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            typeface = a.getFont(R.styleable.ColorArcProgressBar_font);
        }
